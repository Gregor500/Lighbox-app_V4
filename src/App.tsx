...
export default function App() {
  ...
  const [frameHoleSpacing, setFrameHoleSpacing] = useState<number>(200);
            ...
            <div className="w-full lg:w-72 flex-shrink-0 flex flex-col gap-6 sticky top-24 self-start">
              ...
              <section className="bg-white p-4 border border-gray-200 rounded-xl shadow-sm flex flex-col gap-4">
                ...
                <label className="flex flex-col gap-1">
                  ...
                  <input type="range" min="200" max="500" step="50" value={frameHoleSpacing} onChange={e => setFrameHoleSpacing(Number(e.target.value))} className="w-full" />
                </label>
