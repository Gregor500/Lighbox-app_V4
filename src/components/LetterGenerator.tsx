...
import { VinylColorMapping } from './VinylColorMapping';
...
export function LetterGenerator() {
  ...
  }, [borders, profiles, activeProfile, filletRadius, sideDepth, frameFlange, frameHoleSpacing, rearFrameInset, rearFrameProfileWidth, rearFrameHoleSpacing]);
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-72 flex-shrink-0 flex flex-col gap-6 sticky top-24 self-start">
              ...
              <section className="bg-white p-4 border border-gray-200 rounded-xl shadow-sm flex flex-col gap-4">
                ...
                <h3 className="font-bold mt-2 border-b border-gray-200 pb-1 text-green-800">Router Settings</h3>
